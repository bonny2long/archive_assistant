"""Bounded checks for v2.057 metadata parser guardrails."""
...
def main() -> None:
    ...
    assert built_book["metadata_assist_version"] == "v2.057"
    ...
    try:
        ...
        audiobook_metadata.extract_audio_metadata = original_extract
    assert built_audiobook["metadata_assist_version"] == "v2.057"
    ...
    print("v2.057 metadata parser guardrail checks passed")
