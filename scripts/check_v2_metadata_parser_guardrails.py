"""Bounded checks for v2.058 metadata parser guardrails."""
...
def main() -> None:
    ...
    try:
        ...
        audiobook_metadata.extract_audio_metadata = original_extract
    assert built_audiobook["metadata_assist_version"] == "v2.058"
    ...
    print("v2.058 metadata parser guardrail checks passed")
