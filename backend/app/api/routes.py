...
def get_batch(batch_id: int, db: Session = Depends(get_db)):
    ...
    metadata.update({
        ...
        "parent_media_extraction_complete": bool(parent_summary.get("parent_media_extraction_complete", False)),
        "parent_extraction_state": parent_summary.get("parent_extraction_state"),
        "active_parent_file_count": int(parent_summary.get("active_parent_file_count", 0) or 0),
        "remaining_primary_file_count": int(parent_summary.get("remaining_primary_file_count", 0) or 0),
        "remaining_support_file_count": int(parent_summary.get("remaining_support_file_count", 0) or 0),
...
def _batch_to_summary(
    ...
    *,
    ...
    return BatchSummary(
        ...
        child_candidate_count=parent_summary["child_candidate_count"],
